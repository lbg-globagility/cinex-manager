    ...
    public partial class frmMovieList : Form
    {
        ...
        public void setDataGridView(DataTable dt)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                dgvResult.Columns[6].ValueType = typeof(DateTime);
                dgvResult.Columns[6].DefaultCellStyle.Format = "MM-dd-yyyy";
                dgvResult.Columns[7].Width = iwidth;
                dgvResult.Columns[7].HeaderText = "End Date";
                dgvResult.Columns[7].ValueType = typeof(DateTime);
                dgvResult.Columns[7].DefaultCellStyle.Format = "MM-dd-yyyy";
                ...
                dgvResult.Columns[9].Visible = false;
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    var photoName = isAdd ? _photoName : (string)dgvResult.CurrentRow?.Cells["photo_name"].Value;

                    var isNullPhoto = Object.Equals(photo, DBNull.Value);
                    var isNullPhotoName = Object.Equals(photoName, DBNull.Value);

                    if (isNullPhoto ? isNullPhoto : photo == null)
