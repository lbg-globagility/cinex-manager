...
DROP PROCEDURE IF EXISTS `reports_cinema_sales_ticket_type_sold`;

CREATE PROCEDURE `reports_cinema_sales_ticket_type_sold`(_start_date DATETIME, _end_date DATETIME)
BEGIN
