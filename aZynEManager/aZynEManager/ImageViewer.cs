...
namespace aZynEManager
{
    public partial class ImageViewer : UserControl
    {
        ...
        private string m_ImageFullFileName;
        ...
        public FileStream BlobFileStream
        {
            set { m_fs = value; }
            get { return m_fs; }
        }
        ...
        {
            set { m_ImageFullFileName = value; }
            get { return m_ImageFullFileName; }
        }
        ...
        public void LoadImageII(Bitmap bmpfile, int width, int height)
        {
            Image tempImage = bmpfile;//Image.FromFile(imageFilename);
            //m_ImageLocation = imageFilename;
        ...
        public void LoadImageIII(Image img, int width, int height)
        {
            Image tempImage = img;//Image.FromStream(ms);
