...
namespace Cinex.WinForm
{
    ...
    {
        int ListenForHotKey(Key key, HotKeyModifiers modifiers, Action keyAction);
    ...
    public class HotKeyHelper : IHotKeyTool
    {
        ...
        //public HotKeyHelper(IDisposable handlerWindow)
        //{
        //}

        //public HotKeyHelper(UserControl handlerWindow)
        //{
        //}
        ...
        public int ListenForHotKey
           (Key key, HotKeyModifiers modifiers, Action doThis)
        {
