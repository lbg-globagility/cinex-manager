...
DROP PROCEDURE IF EXISTS `retrieve_movies_schedule_list_patron_mslid`;
DELIMITER //
CREATE PROCEDURE `retrieve_movies_schedule_list_patron_mslid`(mlsid INT, movie_date DATETIME)
BEGIN
