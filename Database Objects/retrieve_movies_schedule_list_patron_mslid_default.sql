...
DROP PROCEDURE IF EXISTS `retrieve_movies_schedule_list_patron_mslid_default`;
DELIMITER //
CREATE PROCEDURE `retrieve_movies_schedule_list_patron_mslid_default`(mlsid INT, movie_date DATETIME)
BEGIN
